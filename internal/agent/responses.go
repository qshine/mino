...
func newResponsesClient(cfg Options, instructions string) *responsesClient {
...
func (c *responsesClient) respond(ctx context.Context, input responses.ResponseInputParam, emit func(string) error) (modelReply, error) {
	...
	if err := stream.Err(); err != nil {
		...
		default:
			...
			return modelReply{}, fmt.Errorf("Request failed. Check your connection and base_url in %s.", "~/.mino/config.json")
		}
	}
